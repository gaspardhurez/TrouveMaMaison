...
with row[1]:
    ...
    df = pd.read_csv('/Users/gaspardhurez/Python/streamlit front-end/department_scores.csv')
    ...
    df_geo = pd.read_csv('/Users/gaspardhurez/Python/streamlit front-end/geo_departments.csv')
    df = pd.merge(df, df_geo, on='department_name')

    geodata = gpd.read_file('/Users/gaspardhurez/Python/streamlit front-end/departements.geojson')
